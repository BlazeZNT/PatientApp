...
<template>
	<view class="date">
		<view class="head">
			<view class="title">{{nowYear+'-'+nowMonth}}</view>
		...
		<swiper :style="{height:(retract ? 2 * 60 : (week_list.length + 1) * 60	 ) + 'rpx'}" :current="current" circular @change="change_date">
			<swiper-item>
...
.head{
	display: flex; align-items: center; height: 100rpx; justify-content: space-between;
	.title{
